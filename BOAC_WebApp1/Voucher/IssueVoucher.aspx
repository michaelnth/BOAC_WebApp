...
<asp:Content ID="Content3" ContentPlaceHolderID="LeftPanelContent" runat="server">
    <div align="center" class="leftColContent">
        <asp:Image ID="Image1" runat="server" 
            ImageUrl="~/Icons/Original/Gift_Voucher.png" Height="80px" />
    </div>
</asp:Content>
                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="3" align="right">
                                <asp:ImageButton ID="IssueImageBtn" runat="server" Height="50px" 
                                    ImageUrl="~/Icons/Original/Gift_Voucher.png" onclick="IssueImageBtn_Click" ToolTip="Issue Voucher" />
                            </td>
                        </tr>   
                        <tr>
                            <td colspan="3" align="right">
